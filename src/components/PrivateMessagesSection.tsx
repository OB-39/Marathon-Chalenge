...
import { MessageSquare, Calendar, User, ChevronRight, Inbox, Clock, Send } from 'lucide-react';
        ...
        <>
            <section className="space-y-6">
                <div className="flex items-center justify-between px-1">
                    ...
                    {/* Bouton Message Groupé (seulement pour les ambassadeurs) */}
                    ...
                    <div className="glass-strong rounded-3xl p-12 text-center border border-white/10">
                        ...
                        <p className="text-sm text-gray-500">
                            {profile?.role === 'ambassador'
                                ...
                                : "Vous n'avez pas encore reçu de messages des ambassadeurs."}
                        </p>
                    </div>
                ) : (
